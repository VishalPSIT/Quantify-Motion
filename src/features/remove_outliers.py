...
df = pd.read_pickle(r"V:\tracking-barbell-exercises\data\interim\01_data_processed.pkl")
...
for col in outlier_columns:
    for label in df["label"].unique():
        ...
        #replace value marked as outliner as NaN
...
outlier_removed_df.to_pickle(r"V:\tracking-barbell-exercises\data\interim\02_outliers_removed_chauvenets.pkl")